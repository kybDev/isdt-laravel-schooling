...
<body>
    ...
    <div class="container" >
        ...
        @endif
        <!-- Content here -->
        <form action="{{ URL::route('crud.save') }}" method="post">
            @csrf
            ...
            <div class="mb-3">
                ...
                <select  name="status" class="form-select" aria-label="Default select example" >
                    ...
                    <option @if(old('status')=="Doing") selected @endif> Doing </option>
                    <option @if(old('status')=="Done") selected @endif> Done </option>
                    <option @if(old('status')=="Canceled") selected @endif> Canceled </option>
                </select>
            </div>
